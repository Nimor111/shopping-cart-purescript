...
import Web.ShoppingCart.Error (type (+), ShoppingCartJsonDecodeError, UserNameInUseError, jsonDecodeError)
...
type HandleRegisterError r
  = Variant (UserNameInUseError + ShoppingCartJsonDecodeError + r)
